...
contingency_table <- function(data, condition_x, condition_y) {
  condition_x <- deparse(substitute(condition_x))
  condition_y <- deparse(substitute(condition_y))
...
retrieve_to_frame_number %>%
  contingency_table(bike_retrieved, frame_number_record) %>%
...
retrieve_to_report %>%
  contingency_table(bike_retrieved, police_report) %>%
...
report_to_frame_number %>%
  contingency_table(police_report, frame_number_record) %>%
